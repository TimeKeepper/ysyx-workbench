...
class Emulator {
    public:
        ...
        void Icache_state_catch(uint32_t write_index, uint32_t write_way, uint32_t write_tag, uint32_t write_data);
        void Icache_MAT_catch(uint32_t cache_hit, uint32_t count);
