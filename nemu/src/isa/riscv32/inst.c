...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 00100 11", srai   , I, imm ^= 0x80000fe0,Print_DBG_Message("srai"),R(rd) = src1 >> imm);
  INSTPAT("0000000 ????? ????? 001 ????? 01100 11", sll    , I, imm ^= 0x80000fe0,Print_DBG_Message("sll"),R(rd) = src1 << src2);
