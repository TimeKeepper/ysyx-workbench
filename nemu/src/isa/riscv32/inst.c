...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 00100 11", srai   , R, Print_DBG_Message("srai"),R(rd) = src1 >> imm);
  INSTPAT("0000000 ????? ????? 001 ????? 01100 11", sll    , R, Print_DBG_Message("sll"),R(rd) = src1 << src2);
  INSTPAT("0000000 ????? ????? 111 ????? 01100 11", and    , R, Print_DBG_Message("and"),printf("src1:%x,src2:%x,src&src2=%x",src1,src2,src1&src2),R(rd) = src1 & src2);
